...
const CourseDetails = () => {
  ...
  useEffect(() => {
    ...
    console.log("Course Data:", courseData); // Debugging course data
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px:8 md:pt-10 text-left">
      ...
      <div className="absolute top-0 left-0 w-full h-[500px] space-z-1 bg-gradient-to-b from-cyan-100/70"></div>
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">{courseData.educator?.name || "Unknown Educator"}</span>
          </p>
              ...
              {courseData.courseContent.map((chapter, index) => (
                <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                  ...
                  >
                    ...
                    <p>
                      {chapter.chapterContent.length} lectures - {calculChapterTime(chapter)}
                    </p>
                  </div>
                  <div
        ...
        {/* Right-column */}
        <div className='max-w-[350px] z-10 shadow-[0px_5px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className="p-5">
            ...
            <p className='md:text-lg text-blue-500 line-through'>{currency}{courseData.coursePrice}</p>
            <p className='md:text-lg text-gray-500'>{currency}{courseData.discount}% off</p>
            </div>
            <div className='text-gray-500 flex gap-4 items-center pt-2 md:pt-4 text-sm md:text-default '>
            ...
            <div className='pt-6'>
              ...
              <ul className=' ml-4 pt-2 md:text-lg text-sm md:text-default list-disc text-gray-500'>
                <li>Lifetime access with free update.</li>
                <li>Step-by-step ,hands on project guidance.</li>
                <li>Downloadable resource and source code.</li>
                <li>Quizes to test your knowldge.</li>

...
const CourseDetails = () => {
  ...
  const [isAlreadyEnroll , setIsAlreadyEnroll]=useState(true)
  const [playerData , setplayerData]=useState(null)
  const {allCourses,calculateRating,calculChapterTime,currency,calculateCourseDuration,calculateNoOfLecture}=useContext(AppContext)
  ...
  return courseData ? (
    <>
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px:8 md:pt-30 pt-18 text-left'>
     <div  className='absolute top-0 left-0 w-full h-[500px] space-z-1 bg-gradient-to-b from-cyan-100/70'></div>

      {/* left-column */}
      <div className='max-w-xl z-10 test-gray-500'>
        ...
        {/*reviews and rating */}
         <div className='flex items-center space-x-2 pt-3 pd-1 text-sm'>
                ...
                <p className='text-sm'>Course by <span className='text-blue-600 underline'>Ishita</span></p>
  ...
  s                        src={assets.down_arrow_icon} 
      ...
      {/* Right-column */}
      <div className='max-w-[425px] z-10 shadow-[0px_5px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          ...
          <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlreadyEnroll ? 'Already Enroll':'Enroll Now'}</button>
          ...
          <div className='pt-6'>
            ...
            <ul className='ml-4 pt-4 text-sm md:text-default list-disc text-gray-500'>
              ...
              <li>Step-by-step hand-ob project guidance.</li>
              <li>Downloadable resourceand source code.</li>

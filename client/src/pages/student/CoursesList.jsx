...
useEffect(()=>{
  if(allCourses && allCourses.length>0){
    ...
    input?
    setFilterdCourse(tempCourses.filter(items=>items.courseTitle.toLowerCase().includes(input.toLowerCase())))
    :setFilterdCourse(tempCourses)
  }
},[allCourses,input])
  return (
    <>
      <div className='relative md:px-36 px:8 pt-18 text-left'>
        ...
        {input && <div className='inline-flex text-center gap-4 px-4 py-2 border mt-8 md-8 text-gray-16'>
          <p>{input}</p>
